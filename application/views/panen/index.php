...
<body class="hold-transition sidebar-mini layout-fixed">
	...
	<?php if ($cek_biodata !== NULL) : ?>
				...
				<div class="sidebar">
					...
					<nav class="mt-2">
						<ul class="nav nav-pills nav-sidebar flex-column menu" data-widget="treeview" role="menu" data-accordion="false">
							...
							<?php endif ?>
							<li class="nav-item">
								<a href="<?= base_url('panen'); ?>" class="nav-link <?php if ($this->uri->uri_string() == 'panen' || $this->uri->uri_string() == 'panen/createPanen' || $this->uri->uri_string() == 'panen/index' || $this->uri->uri_string() == 'panen/index/' . 'accafdeling' || $this->uri->uri_string() == 'panen/index/' . 'accunit'  || $this->uri->uri_string() == 'panen/index/' . 'selesai') {
																						echo 'active';
																					} ?>">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-8">
							<?php if ($this->session->userdata('jabatan') == 'Administrator' or $this->session->userdata('jabatan') == 'Kepala Bagian Operasional') : ?>
								<h1><i class="fa-solid fa-tractor"></i> Panen Hari ini</h1>
							<?php elseif ($this->session->userdata('jabatan') == 'Manajer Unit') : ?>
								<h1><i class="fa-solid fa-tractor"></i> Panen Hari ini - Unit <?= $dataUser['nama_unit']; ?></h1>
							<?php else : ?>
								<h1><i class="fa-solid fa-tractor"></i> Panen Hari ini - Unit <?= $dataUser['nama_unit']; ?> - <?= $dataUser['nama_afdeling']; ?></h1>
							<?php endif ?>
						</div>
						<?php if ($this->session->userdata('jabatan') == 'Kerani Panen') : ?>
							<div class="col-sm-4">
								<ol class="breadcrumb float-sm-right">
									<a href="" data-toggle="modal" data-target="#tambahPanenModal" class="btn btn-primary"><i class="fa-solid fa-tractor"></i></i> <sup><i class="fas fa-fw fa-plus"></i></sup> Tambah Panen</a>
								</ol>
							</div>
						<?php endif ?>
					</div>
			...
			<!-- Modal Tambah Panen -->
			<div class="text-left modal fade" id="tambahPanenModal" tabindex="-1" role="dialog" aria-labelledby="tambahPanenModalLabel" aria-hidden="true">
				<div class="modal-dialog" role="document">
					<form action="<?= base_url('panen/createPanen'); ?>" method="post">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title" id="tambahPanenModalLabel"><i class="fas fa-fw fa-handshake"></i> <sup><i class="fas fa-fw fa-plus"></i></sup> Tambah Panen</h5>
								<button type="button" class="close" data-dismiss="modal" aria-label="Close">
									<span aria-hidden="true">&times;</span>
								</button>
							</div>
							<div class="modal-body">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="form-group">
											...
											<input type="hidden" name="id_afdeling" value="<?= $this->session->userdata('id_afdeling'); ?>">
								...
								<div class="row">
									<div class="col-lg-6">
										<div class="form-group">
											...
											<input min="0" placeholder="0" type="number" onkeyup="pembagian()" name="jumlah_tandan" id="jumlah_tandan" class="form-control" value="<?= set_value('jumlah_tandan'); ?>">
											<?= form_error('jumlah_tandan', '<small class="form-text text-danger">', '</small>'); ?>
										</div>
									</div>
									<div class="col-lg-6">
										<div class="form-group">
											<label for="tandan_kg">Tandan (Kg)</label>
											<input min="0" placeholder="0" type="number" onkeyup="pembagian()" name="tandan_kg" id="tandan_kg" class="form-control" value="<?= set_value('tandan_kg'); ?>">
								...
								<div class="form-group">
									<label for="rata_tandan">Rata-rata Kg/Tandan</label>
									<input readonly min="0" placeholder="0" type="number" name="rata_tandan" id="rata_tandan" class="form-control" value="<?= set_value('rata_tandan'); ?>">
								...
								<div class="row">
									...
									<div class="col-lg-6">
										<div class="form-group">
											...
											<input min="0" placeholder="0" type="number" name="brondolan" id="brondolan" class="form-control" value="<?= set_value('brondolan'); ?>">
											<?= form_error('brondolan', '<small class="form-text text-danger">', '</small>'); ?>
										</div>
									</div>
									<div class="col-lg-6">
										<div class="form-group">
											<label for="tandan_mentah" style="color: red;"><b>Tandan Mentah</b></label>
											<input min="0" placeholder="0" type="number" name="tandan_mentah" id="tandan_mentah" class="form-control" value="<?= set_value('tandan_mentah'); ?>">
							...
							<div class="modal-footer">
								<button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fas fa-fw fa-times"></i> Batal</button>
								<button type="submit" name="btnTambahPanen" class="btn btn-primary"><i class="fas fa-fw fa-paper-plane"></i> Kirim</button>
							</div>
						</div>
					</form>
				</div>
								...
								<div class="card-header">
									<div class="row justify-content-center text-center my-2">
										...
										<div class="col-md m-1 px-0">
											<a href="<?= base_url('panen/index/'); ?>" class="btn btn-secondary">Semua</a> <span class="badge badge-secondary"><?= isset($jumlah_status_panen_semua['semua']) ?></span>
										</div>
										<div class="col-md m-1 px-0">
											<a href="<?= base_url('panen/index/' . 'accafdeling'); ?>" class="btn btn-danger">Approve Afdeling</a> <span class="badge badge-danger"><?= isset($jumlah_status_panen_accafdeling['accafdeling']) ?></span>
										</div>
										<div class="col-md m-1 px-0">
											<a href="<?= base_url('panen/index/' . 'accunit'); ?>" class="btn btn-warning text-white">Approve Unit</a> <span class="badge badge-warning text-white"><?= isset($jumlah_status_panen_accunit['accunit']) ?></span>
										</div>
										<!-- <div class="col-md m-1 px-0">
								<a href="<?= base_url('panen/index/' . 'accops'); ?>" class="btn btn-info">Acc Bag.Ops Sawit</a> <span class="badge badge-info"><?= isset($jumlah_status_panen_accops['accops']) ?></span>
							</div> -->
										<div class="col-md m-1 px-0">
											<a href="<?= base_url('panen/index/' . 'selesai'); ?>" class="btn btn-success">Selesai</a> <span class="badge badge-success"><?= isset($jumlah_status_panen_selesai['selesai']) ?></span>
										</div>
									</div>
								</div>
							<?php endif ?>
														...
														<?php foreach ($panen as $dt) : ?>
															...
															<span class="badge badge-secondary"><i class="fas fa-fw fa-clock"></i> Menunggu Approve<br>Kepala Bagian Operasional</span> -->
																	...
																	<?php else : ?>
																		...
																		<?php elseif ($dt['status_panen'] == 'ditolak' and $dt['penolak'] == 'Asisten Afdeling') : ?>
																			<span class="text-white badge badge-secondary"><i class="fas fa-fw fa-clock"></i> Menunggu Approve<br>Asisten Afdeling</span>

																		<?php elseif ($dt['status_panen'] == 'ditolak' and $dt['penolak'] == 'Manajer Unit') : ?>
																			<?php if ($this->session->userdata('jabatan') == 'Asisten Afdeling') : ?>
																		...
																		<?php elseif ($dt['status_panen'] == 'accunit') : ?>
																			...
																			<?php else : ?>
																				<span class="badge badge-secondary"><i class="fas fa-fw fa-clock"></i> Menunggu Approve<br>Manajer Unit</span>
																			<?php endif ?>
																...
																<td class="row">
																	...
																	<a href="<?= base_url('panen/detailpanen/') . $dt['id_panen']; ?>" class="m-1 badge badge-warning text-white"><i class="fas fa-fw fa-align-justify"></i> Detail</a>
															...
															<div class="text-left modal fade" id="ubahPanenModal<?= $dt['id_panen']; ?>" tabindex="-1" role="dialog" aria-labelledby="ubahPanenModalLabel<?= $dt['id_panen']; ?>" aria-hidden="true">
																<div class="modal-dialog" role="document">
																	<form action="<?= base_url('panen/updatePanen/') . $dt['id_panen']; ?>" method="post">
																		<div class="modal-content">
																			<div class="modal-header">
																				<h5 class="modal-title" id="ubahPanenModalLabel<?= $dt['id_panen']; ?>"><i class="fas fa-fw fa-tractor"></i> <sup><i class="fas fa-fw fa-edit"></i></sup> Ubah Panen - <?= $dt['kode_panen']; ?></h5>
																				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
																					<span aria-hidden="true">&times;</span>
																				</button>
																			</div>
